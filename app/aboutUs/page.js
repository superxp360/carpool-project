...
export default function aboutUs () {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p className="mb-8 leading-relaxed">Welcome to Ride Share! Our mission is to provide a safe, convenient, and eco-friendly way for people to travel together and reduce their carbon footprint. Our app allows users to connect with one another and share rides to their desired destinations.
